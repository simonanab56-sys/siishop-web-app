...
module.exports = {
   ...
   */
  getCitiesByRegion: function (region) {
    return this.citiesByRegion[region] || [];
  },
   ...
   * @returns {boolean}
   */
  isValidCity: function (region, city) {
    const cities = this.citiesByRegion[region] || [];
